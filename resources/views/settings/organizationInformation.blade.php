    ...
    <div class="panel-body">
        <div class="create-form settings-form org-info-form">
            ...
            <div class="col-md-12 col-xs-12 single-form-wrap">
                ...
                <div class="description col-xs-12 col-sm-6 col-md-6"> trans('organisation.please_insert_a_valid_twitter_username_example') '@oxfam ' or 'oxfam'</div>
            </div>
            <div class="col-md-12 col-xs-12 single-form-wrap">
                {!! AsForm::text(['name' => 'telephone', 'label' => trans('organisation_telephone_number'), 'parent' => 'col-xs-12 col-sm-6 col-md-6']) !!}
            </div>
