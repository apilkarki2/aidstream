...
@section('panel-body')
    <div class="create-form create-user-form settings-form users-form">
        ...
        <div class="col-md-12">
            {!! AsForm::text(['name' => 'first_name', 'parent' => 'col-sm-6', 'required' => true]) !!}
            {!! AsForm::text(['name' => 'last_name','parent' => 'col-sm-6', 'required'=> true]) !!}
        </div>
        <div class="col-md-12 single-form-wrap">
            {!! AsForm::text(['name' => 'email','parent' => 'col-sm-6','required'=> true]) !!}
        </div>
        <div class="col-md-12 single-form-wrap">
            {!! AsForm::text(['name' => 'username', 'parent' => 'col-sm-6', 'required' => true, 'class' => 'username']) !!}
        </div>
        <div class="col-md-12">
            {!! AsForm::password(['name' => 'password','parent' => 'col-sm-6', 'required' => true]) !!}
