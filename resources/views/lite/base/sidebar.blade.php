    ...
    <div class="col-xs-12 col-md-3 col-lg-3 sidebar-wrapper">
        <div class="panel panel-default">
            <div class="panel-body">
                <ul class="nav">
                    <li class="activities" data-step="2"><a href="{{ route('lite.activity.index') }}">Activities</a></li>
                    {{--<li class="organization" data-step="3"><a href="{{ route('organization.show', session('org_id')) }}">Organisation</a></li>--}}
                    <li class="published-files" data-step="4"><a href="#">Published Files</a></li>
                    ...
                    <li class="settings" data-step="7"><a href="#">Settings</a></li>
