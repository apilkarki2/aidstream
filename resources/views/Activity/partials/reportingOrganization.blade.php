        ...
        <div class="activity-element-list">
            ...
            <div class="activity-element-info">
                <li>{!! checkIfEmpty(getFirstNarrative(getVal($activityDataList, ['reporting_org', 0], []))) !!}
                    @include('Activity.partials.viewInOtherLanguage' ,['otherLanguages' => getOtherLanguages(getVal(getVal($activityDataList, ['reporting_org', 0], []), ['narrative'], []))])
                </li>
                ...
                <div class="more-info hidden">
                    <div class="element-info">
                        ...
                        <div class="activity-element-info">{!! checkIfEmpty(getVal(getVal($activityDataList, ['reporting_org', 0], []), ['reporting_organization_identifier'], [])) !!}</div>
                    </div>
                    <div class="element-info">
                        <div class="activity-element-label">@lang('elementForm.organisation_type')</div>
                        <div class="activity-element-info">{!! substr($getCode->getOrganizationCodeName('OrganizationType', getVal(getVal($activityDataList, ['reporting_org', 0], []), ['reporting_organization_type'])), 0, -4) !!}</div>
                    </div>
                </div>
            </div>
        </div>
